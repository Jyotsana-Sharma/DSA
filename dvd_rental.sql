--
-- dvdrental schema restore → loading into database: dma_test
--
-- HOW TO RUN (pgAdmin): make sure you are connected to dma_test, then
--   run this file via Query Tool (you are already doing this correctly).
--
-- HOW TO RUN (psql terminal alternative):
--   psql -U postgres -d dma_test -f dvdrental_fixed.sql
--
-- All .dat files must be in the same directory as this SQL file.
-- Data files expected: 3055.dat 3057.dat 3059.dat 3061.dat 3062.dat 3063.dat
--                      3065.dat 3067.dat 3069.dat 3071.dat 3073.dat 3075.dat
--                      3077.dat 3079.dat 3081.dat
--
...
--
-- Aggregate (must come before views that use group_concat)
--
...
--
-- rewards_report function (depends on customer table)
--
...
--
-- Data load — files copied to /tmp/dvdrental so the postgres server process can read them.
-- Before running this script, open Terminal and run:
--   sudo mkdir -p /tmp/dvdrental
--   sudo cp "/Users/jyotsanasharma/Downloads/dvdrental 2/"*.dat /home/
--   sudo chmod 755 /tmp/dvdrental
--   sudo chmod 644 /home/*.dat
--
...
ALTER TABLE ONLY public.address ADD CONSTRAINT fk_address_city FOREIGN KEY (city_id) REFERENCES public.city(city_id);
ALTER TABLE ONLY public.city ADD CONSTRAINT fk_city FOREIGN KEY (country_id) REFERENCES public.country(country_id);
...
ALTER TABLE ONLY public.payment ADD CONSTRAINT payment_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customer(customer_id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.payment ADD CONSTRAINT payment_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES public.rental(rental_id) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE ONLY public.payment ADD CONSTRAINT payment_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(staff_id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.rental ADD CONSTRAINT rental_staff_id_key FOREIGN KEY (staff_id) REFERENCES public.staff(staff_id);
...
ALTER TABLE ONLY public.store ADD CONSTRAINT store_manager_staff_id_fkey FOREIGN KEY (manager_staff_id) REFERENCES public.staff(staff_id) ON UPDATE CASCADE ON DELETE RESTRICT;
